...
def screwing_process(frame):
    global screw_coordinates, screwdriver_tag_id, start_time, screw_index
    ...
    # check if the nearest screw is the next screw to be screwed
        if nearest_screw == screw_index:
            ...
            cv2.circle(frame, (screw_coordinates[nearest_screw][0], screw_coordinates[nearest_screw][1]), 8, (0, 255, 0), 8)
            ...
            start_time = 0
            # Draw a circle at the nearest screw
            cv2.circle(frame, (screw_coordinates[nearest_screw][0], screw_coordinates[nearest_screw][1]), 8, (0, 0, 255), 8)
